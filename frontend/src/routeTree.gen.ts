...
const AppMessagesConversationIdRoute = AppMessagesConversationIdRouteImport.update({
  id: "/$conversationId",
  path: "/$conversationId",
  getParentRoute: () => AppMessagesRoute,
} as any);
const AppHackathonsHackathonIdRoute = AppHackathonsHackathonIdRouteImport.update({
  id: "/$hackathonId",
  path: "/$hackathonId",
...
const AppProjectsProjectIdIssuesRoute = AppProjectsProjectIdIssuesRouteImport.update({
  id: "/issues",
  path: "/issues",
...
const AppBuildersRouteWithChildren = AppBuildersRoute._addFileChildren(AppBuildersRouteChildren);
...
const AppMessagesRouteWithChildren = AppMessagesRoute._addFileChildren(AppMessagesRouteChildren);
