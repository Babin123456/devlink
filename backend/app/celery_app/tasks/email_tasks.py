...
def send_verification_email_task(self, email_to: str, username: str, verification_url: str, expire_hours: int):
    try:
        run_async_email(email_service._send_email_async(
...
@celery_app.task(bind=True, max_retries=3, default_retry_delay=60)
def send_password_reset_email_task(self, email_to: str, username: str, reset_url: str, expire_hours: int):
    try:
        run_async_email(email_service._send_email_async(
...
@celery_app.task(bind=True, max_retries=3, default_retry_delay=60)
def send_invitation_email_task(self, email_to: str, inviter_name: str, project_name: str, invitation_url: str):
    try:
        run_async_email(email_service._send_email_async(
...
@celery_app.task(bind=True, max_retries=3, default_retry_delay=60)
def send_mention_email_task(self, email_to: str, username: str, mentioner_name: str, context_name: str, mention_text: str, context_url: str):
    try:
        run_async_email(email_service._send_email_async(
...
@celery_app.task(bind=True, max_retries=3, default_retry_delay=60)
def send_app_update_email_task(self, email_to: str, username: str, update_title: str, update_content: str, action_url: str):
    try:
        run_async_email(email_service._send_email_async(
