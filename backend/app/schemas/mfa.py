...
class MFASetupResponse(BaseModel):
    ...
    provisioning_uri: str = Field(..., description="otpauth:// URI for authenticator setup")
...
class MFAVerifyLoginRequest(BaseModel):
    mfa_token: str = Field(..., description="Short-lived pending MFA authentication token")
