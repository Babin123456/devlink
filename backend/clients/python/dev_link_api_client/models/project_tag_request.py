...
T = TypeVar("T", bound="ProjectTagRequest")


@_attrs_define
class ProjectTagRequest:
    """Request to generate project tags.

    Attributes:
        title (str): Project title
        description (str): Project description
        tech_stack (None | str | Unset): Optional tech stack string
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_tag_request = cls(
            title=title,
            description=description,
            tech_stack=tech_stack,
        )

        project_tag_request.additional_properties = d
        return project_tag_request
