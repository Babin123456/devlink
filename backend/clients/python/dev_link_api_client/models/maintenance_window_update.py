...
T = TypeVar("T", bound="MaintenanceWindowUpdate")
...
class MaintenanceWindowUpdate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        maintenance_window_update.additional_properties = d
        return maintenance_window_update
