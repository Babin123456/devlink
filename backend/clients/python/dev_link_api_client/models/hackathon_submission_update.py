...
T = TypeVar("T", bound="HackathonSubmissionUpdate")


@_attrs_define
class HackathonSubmissionUpdate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hackathon_submission_update = cls(
            title=title,
        ...
        hackathon_submission_update.additional_properties = d
        return hackathon_submission_update
