...
T = TypeVar("T", bound="SearchSuggestionTag")


@_attrs_define
class SearchSuggestionTag:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_suggestion_tag = cls(
            name=name,
            project_count=project_count,
        )

        search_suggestion_tag.additional_properties = d
        return search_suggestion_tag
