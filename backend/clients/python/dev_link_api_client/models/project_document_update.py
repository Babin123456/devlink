...
T = TypeVar("T", bound="ProjectDocumentUpdate")


@_attrs_define
class ProjectDocumentUpdate:
    """
    Attributes:
        title (None | str | Unset):
        content (None | str | Unset):
        base_version (int | None | Unset): Base version for optimistic concurrency conflict resolution
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_document_update = cls(
            title=title,
            content=content,
            base_version=base_version,
        )

        project_document_update.additional_properties = d
        return project_document_update
