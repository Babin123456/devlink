...
from ...models.hackathon_registration_create import HackathonRegistrationCreate
...
def _get_kwargs(
    hackathon_id: UUID,
    *,
    body: HackathonRegistrationCreate,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = HackathonRegistrationResponse.from_dict(response.json())
