...
from ...models.hackathon_submission_create import HackathonSubmissionCreate
...
def _get_kwargs(
    hackathon_id: UUID,
    *,
    body: HackathonSubmissionCreate,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = HackathonSubmissionResponse.from_dict(response.json())
